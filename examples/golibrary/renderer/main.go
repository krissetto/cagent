...
func newRepoRenderer(animationRuntime *animation.Runtime, msg *types.Message, ss service.SessionStateReader) layout.Model {
	return toolcommon.NewBase(animationRuntime, msg, ss, renderRepoSearch)
}
