...
func TestBuildSessionTreeLines_RootOnly(t *testing.T) {
	...
	root := runtime.LiveSessionNode{
		ID: "root-1", RootSessionID: "root-1",
...
func TestBuildSessionTreeLines_NestedStructure(t *testing.T) {
	...
	nodes := []runtime.LiveSessionNode{
		{ID: "root-1", RootSessionID: "root-1", Kind: runtime.LiveSessionRoot, AgentName: "orchestrator", Status: "running", CreatedAt: now.Add(-5 * time.Minute)},
		{ID: "planner-1", ParentID: "root-1", RootSessionID: "root-1", Kind: runtime.LiveSessionSubAgent, AgentName: "planner", Status: "running", CreatedAt: now.Add(-4 * time.Minute)},
		{ID: "researcher-1", ParentID: "planner-1", RootSessionID: "root-1", Kind: runtime.LiveSessionSubAgent, AgentName: "researcher", Status: "waiting", CreatedAt: now.Add(-3 * time.Minute)},
		{ID: "writer-1", ParentID: "planner-1", RootSessionID: "root-1", Kind: runtime.LiveSessionSubAgent, AgentName: "writer", Status: "failed", CreatedAt: now.Add(-2 * time.Minute), Error: "unexpected EOF"},
		{ID: "reviewer-1", ParentID: "root-1", RootSessionID: "root-1", Kind: runtime.LiveSessionSubAgent, AgentName: "reviewer", Status: "closed", CreatedAt: now.Add(-time.Minute)},
	}
...
func TestBuildSessionTreeLines_SiblingOrderDeterministic(t *testing.T) {
	...
	now := time.Now()
	nodes := []runtime.LiveSessionNode{
		{ID: "root-1", Kind: runtime.LiveSessionRoot, AgentName: "root", Status: "running", CreatedAt: now.Add(-10 * time.Minute)},
		{ID: "c", ParentID: "root-1", Kind: runtime.LiveSessionSubAgent, AgentName: "gamma", Status: "running", CreatedAt: now.Add(-3 * time.Minute)},
		{ID: "a", ParentID: "root-1", Kind: runtime.LiveSessionSubAgent, AgentName: "alpha", Status: "running", CreatedAt: now.Add(-5 * time.Minute)},
		{ID: "b", ParentID: "root-1", Kind: runtime.LiveSessionSubAgent, AgentName: "beta", Status: "running", CreatedAt: now.Add(-4 * time.Minute)},
	}
...
func TestBuildSessionTree_RowsMapLinesToNodes(t *testing.T) {
	...
	now := time.Now()
	nodes := []runtime.LiveSessionNode{
		{ID: "root", RootSessionID: "root", Kind: runtime.LiveSessionRoot, AgentName: "root", Status: "running", CreatedAt: now.Add(-10 * time.Minute)},
		{ID: "planner", ParentID: "root", Kind: runtime.LiveSessionSubAgent, AgentName: "planner", Status: "running", CreatedAt: now.Add(-5 * time.Minute)},
		{ID: "writer", ParentID: "planner", Kind: runtime.LiveSessionSubAgent, AgentName: "writer", Status: "failed", Error: "boom", CreatedAt: now.Add(-time.Minute)},
	}
	...
	writer := rows[2]
	assert.Equal(t, "writer", writer.Node.ID)
...
func TestSessionTreeDialog_InitialSelectionMatchesCurrentSession(t *testing.T) {
	...
	now := time.Now()
	nodes := []runtime.LiveSessionNode{
		{ID: "root", Kind: runtime.LiveSessionRoot, AgentName: "root", Status: "running", CreatedAt: now.Add(-5 * time.Minute)},
		{ID: "a", ParentID: "root", Kind: runtime.LiveSessionSubAgent, AgentName: "a", Status: "running", CreatedAt: now.Add(-4 * time.Minute)},
		{ID: "b", ParentID: "root", Kind: runtime.LiveSessionSubAgent, AgentName: "b", Status: "running", CreatedAt: now.Add(-3 * time.Minute)},
	}
	...
	assert.Equal(t, "b", dlg.rows[dlg.selected].Node.ID)
}
...
func TestSessionTreeDialog_ArrowKeysMoveSelection(t *testing.T) {
	...
	_ = dlg.SetSize(120, 40)
	_ = dlg.View()
	require.Equal(t, "root", dlg.rows[dlg.selected].Node.ID)
...
func TestSessionTreeDialog_HitTestRowMatchesRenderedSelection(t *testing.T) {
	...
	nodes := []runtime.LiveSessionNode{
		{ID: "root", Kind: runtime.LiveSessionRoot, AgentName: "root", Status: "running", CreatedAt: now.Add(-5 * time.Minute)},
		{ID: "planner", ParentID: "root", Kind: runtime.LiveSessionSubAgent, AgentName: "planner", Status: "running", CreatedAt: now.Add(-4 * time.Minute)},
	}
