...
type HitTest struct {
	...
	SubagentID      string // short id populated when At() returns TargetSidebarSubagent
	ParentSessionID string // populated when At() returns TargetSidebarParent
}
