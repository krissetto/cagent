...
func TestAddDelegationCard(t *testing.T) {
	...
	cmd := m.AddDelegationCard("ab3k9", "reviewer", "review this code")
	...
	assert.False(t, msg.DelegationDone)
	assert.False(t, msg.DelegationFailed)
	assert.Empty(t, msg.DelegationReply)
}
...
func TestUpdateDelegationCard_Done(t *testing.T) {
	...
	m.AddDelegationCard("ab3k9", "reviewer", "review this code")
	require.Len(t, m.messages, 1)
...
func TestAddDelegationCard_ContinuationReactivates(t *testing.T) {
	...
	m.AddDelegationCard("abc12", "reviewer", "first task")
	require.Len(t, m.messages, 1)
	...
	m.AddDelegationCard("abc12", "reviewer", "follow-up task")
