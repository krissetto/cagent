...
// input. Waiting children are excluded unless they already have pending
// inbox work queued by the parent OR they themselves have live
// descendants that may still publish updates upward.
//
